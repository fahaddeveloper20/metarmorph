 document.addEventListener('DOMContentLoaded', function () {
            ...
            const testimonialsData = [
                { name: "Sophia M.", location: "— United States", image: "sofi1.png", alt: "Sophia M.", rating: 5, text: "Metamorph Solutions transformed our online presence! Their design and development services are top-notch, delivering a visually stunning and user-friendly website that perfectly aligns with our brand. Highly recommended!", avatarFirst: true },
                { name: "James L.", location: "— Canada", image: "sofi.png", alt: "James L.", rating: 5, text: "The team at Metamorph is incredibly talented. They took our vague ideas and crafted a brilliant brand identity and website. Their collaborative approach made the whole process a pleasure.", avatarFirst: false },
                { name: "Alina K.", location: "— Germany", image: "sofi.png", alt: "Alina K.", rating: 4, text: "Working with Metamorph Solutions was seamless. Their project management was excellent, and they delivered results that exceeded our expectations for our new mobile app.", avatarFirst: true },
                { name: "David R.", location: "— Australia", image: "sofi1.png", alt: "David R.", rating: 5, text: "As a startup, we needed a flexible and creative team. Metamorph provided just that, helping us launch our MVP with a fantastic design and solid backend. Will definitely work with them again!", avatarFirst: false },
                { name: "Priya S.", location: "— India", image: "sofi.png", alt: "Priya S.", rating: 5, text: "Their digital marketing insights combined with their design prowess gave our campaign a significant boost. The animated ad creatives were particularly effective.", avatarFirst: true },
                { name: "Kenji T.", location: "— Japan", image: "sofi1.png", alt: "Kenji T.", rating: 4, text: "The UI/UX improvements on our e-commerce platform led to a noticeable increase in conversion rates. The team was very responsive to feedback.", avatarFirst: false }
            ];
